      ...
      <div className="mx-auto max-w-7xl">
        <div className="flex flex-col items-center gap-8 md:flex-row md:justify-between">
          ...
          <nav className="flex flex-wrap items-center justify-center gap-6">
            <a href="#catalog" className="text-sm text-muted-foreground transition-colors hover:text-primary">
              Каталог
            </a>
            <a href="#about" className="text-sm text-muted-foreground transition-colors hover:text-primary">
              О нас
            </a>
            <a href="#delivery" className="text-sm text-muted-foreground transition-colors hover:text-primary">
              Доставка
            </a>
